...
| [job-radar](job-radar/) | Remote control for [kc_job_radar](https://github.com/KerberosClaw/kc_job_radar) — write cover letters, manage job pipeline, refresh tracking sheet, all via Telegram. Requires kc_job_radar deployed on the same machine with Docker |
