...
| [job-radar](job-radar/) | [kc_job_radar](https://github.com/KerberosClaw/kc_job_radar) 的遙控指令 — 寫求職信、管理求職 pipeline、刷新追蹤表，全部透過 Telegram 操作。需要 kc_job_radar 已部署在同一台機器上並安裝 Docker |
